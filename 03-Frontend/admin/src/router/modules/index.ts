...
const modules: Record<string, () => Promise<unknown>> = {
  'student/portal': () => import('@/views/student/portal.vue'),
...
export const asyncRoutes: RouteRecordRaw[] = [
  ...
  {
    // 学生门户：仅学生角色拥有 student:portal 权限时注册；放数组末尾，
    // 避免影响 admin 等全权限角色的登录落点（firstMenuPath 取首个有权限路由）。
    path: '/portal',
    name: 'admin-student-portal',
    component: modules['student/portal'],
    meta: { title: '学生门户', icon: 'User', permission: 'student:portal' },
  },
]
