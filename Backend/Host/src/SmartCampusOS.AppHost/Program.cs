...
var mysqlIdentity = builder.AddMySql("mysql-identity").AddDatabase("identity-db");
var mysqlEdu = builder.AddMySql("mysql-edu").AddDatabase("edu-db");
var mysqlDorm = builder.AddMySql("mysql-dorm").AddDatabase("dorm-db");
var mysqlNotice = builder.AddMySql("mysql-notice").AddDatabase("notice-db");
var mysqlData = builder.AddMySql("mysql-data").AddDatabase("data-db");
var mysqlPush = builder.AddMySql("mysql-push").AddDatabase("push-db");
var mysqlFile = builder.AddMySql("mysql-file").AddDatabase("file-db");
